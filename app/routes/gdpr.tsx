  ...
  return (
    <div className="p-10 flex flex-col items-center">
      <div className="prose pb-10">
        ...
        <h3>All the images used on this app (like the wine drinking urangutan wearing a suit below) were created by <a href="https://openai.com/dall-e-2">DALL·E 2</a></h3>
      </div>
